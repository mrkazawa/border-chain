...
async function main() {
    ...
    var RegistryContract = new web3.eth.Contract(obj.abi, contract.address);
    
    RegistryContract.methods.isTrustedGateway(ISP.address).call({from: owner.address}).then(console.log);
